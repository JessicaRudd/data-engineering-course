...
table_name = 'fhv_tripdata_{{ data_interval_start.strftime(\'%Y-%m\') }}'
dataset_url = URL_PREFIX + f'/{dataset_file}' 
...
with DAG(
    dag_id="data_ingestion_gcs_dag_monthly_fhv",
    ...
    download_dataset_task >> format_to_parquet_task >> local_to_gcs_task >> remove_dataset_task # >> bigquery_external_table_task 